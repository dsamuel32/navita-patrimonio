...
public class SwaggerConfig {
    ...
    private final String PACOTE = "br.com.navita.patrimonio.apresentacao";
    private final String EMAIL = "diego.samuel.alves@gmail.com";
    private final String PROJETO = "NAVITA-PATRIMONIO";
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                                                      .apis(RequestHandlerSelectors.basePackage("br.com.navita.patrimonio.apresentacao"))
